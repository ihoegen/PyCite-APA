...
def apa_author():
    ...
    if amount_authors == "1":
        ...
        author_first = raw_input("What is the first author's first name? ")
        author_last = raw_input("What is the first author's last name? ")
        author_last = author_last[0].upper() + author_last[1:].lower()
        author_first = author_first[0].upper()
        author_first1 = raw_input("What is the second author's first name? ")
        author_last1 = raw_input("What is the second author's last name? ")
        author_last1 = author_last1[0].upper() + author_last1[1:].lower()
        author_first1 = author_first1[0].upper()
        return "%s, %s., & %s, %s. " %(author_last, author_first, author_last1, author_first1)    
        ...
        author_last1 = author_last1[0].upper() + author_last1[1:].lower()
        author_first1 = author_first1[0].upper()
        author_first2 = raw_input("What is the third author's first name? ")
        author_last2 = raw_input("What is the third author's last name? ")
        author_last2 = author_last2[0].upper() + author_last2[1:].lower()
        author_first2 = author_first2[0].upper()
        return "%s, %s., %s, %s., %s, %s. " %(author_last, author_first, author_last1, author_first1, author_last2, author_first2) 
        ...
        author_last2 = author_last2[0].upper() + author_last2[1:].lower()
        author_first2 = author_first2[0].upper()
        author_first3 = raw_input("What is the fourth author's first name? ")
        author_last3 = raw_input("What is the fourth author's last name? ")
        author_last3 = author_last3[0].upper() + author_last3[1:].lower()
        author_first3 = author_first3[0].upper()
        return "%s, %s., %s, %s., %s, %s., %s, %s. " %(author_last, author_first, author_last1, author_first1, author_last2, author_first2, author_last3, author_first3)     
    elif amount_authors == "4+":
        author_first = raw_input("What is the first author's first name? ")
        author_last = raw_input("What is the first author's last name? ")
        author_last = author_last[0].upper() + author_last[1:].lower()
        ...
        author_last3 = author_last3[0].upper() + author_last3[1:].lower()
        author_first3 = author_first3[0].upper()
        return "%s, %s., %s, %s., %s, %s., %s, %s. et al. " %(author_last, author_first, author_last1, author_first1, author_last2, author_first2, author_last3, author_first3) 
    else: 
